...
// TODO move instructions from ImportContacts purchase step
    ...
    return (
      <div className={s.container}>
        <Row type='flex' gutter={20}>
          <Col xs={24} md={12}>
            <section>
              <h1 className={s.header}>How To Export Contacts</h1>
          ...
          <Col xs={24} md={6}>
            <section>
              <h1 className={s.header}>Upload</h1>
          ...
          <Col xs={24} md={6}>
            <section>
              <h1 className={s.header}>Connect</h1>
